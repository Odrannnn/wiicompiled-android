...
The Builder edition completes the rest on the tablet. It packages signed ARM64 Native AOT translator and Clang/LLD tools plus a game-free runtime SDK, translates the extracted binaries, compiles and links a private runtime, and activates it without Termux or a PC. The verified `0.3.0-alpha.2` APK is 221.3 MiB and requires at least 4 GiB free during the build. Generated code and the resulting runtime remain in app-private storage.
